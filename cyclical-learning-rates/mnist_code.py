...
history = mnist_model.fit(train_images, train_labels, epochs=epochs, steps_per_epoch=10,
                          validation_split=0.2, callbacks=[lr_scheduler], verbose=2)
...
lr_values = [lr_schedule(epoch) * 50 for epoch in range(epochs)]
